# Vetra - A Chat Application Site

This is the **frontend** of Vetra, built with [Next.js](https://nextjs.org).
...
The backend for this project is built using **FastAPI**. You can find the repository for the backend [here](https://github.com/osegbu/vetra).
